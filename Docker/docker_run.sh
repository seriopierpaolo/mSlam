...
DOCKER_DEFAULT_ARGS+=("-v /home/pierpaolo/workspace/mSlam3/:/usr/src/workspace ")
DOCKER_DEFAULT_ARGS+=("--network host")
DOCKER_DEFAULT_ARGS+=("--gpus all")
DOCKER_DEFAULT_ARGS+=("--runtime nvidia")
DOCKER_DEFAULT_ARGS+=("--device=/dev/dri")
DOCKER_DEFAULT_ARGS+=("--group-add video")
docker run ${DOCKER_DEFAULT_ARGS[@]} --name biorbcont biorb bash ;
